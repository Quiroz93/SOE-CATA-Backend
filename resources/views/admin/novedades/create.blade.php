...
<div class="admin-page">
    <div class="admin-header">
        <h1 class="admin-header__title">Registrar Nueva Novedad</h1>
    </div>
    ...
    <div class="admin-form-card">
        <form action="{{ route('admin.novedades.store') }}" method="POST" class="admin-form">
            ...
            <div class="form-group">
                ...
                <textarea name="detalle" id="detalle" class="form-textarea @error('detalle') form-textarea--error @enderror" rows="4" placeholder="Ingresa los detalles de la novedad...">{{ old('detalle') }}</textarea>
                @error('detalle')
                    <span class="form-error">{{ $message }}</span>
                @enderror
            </div>
